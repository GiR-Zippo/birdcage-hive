    ...
    def internalCommands(self,args):
        ...
        if (args.split(" ")[0] == "ls"):
            ...
            try:
                ...
                d = self.dir
            self.CP.command("320 1 " + d, self)
            return True
        elif (args.split(" ")[0] == "cd"):
            if (args.split(" ")[1][0] == "/"):
                self.dir = args.split(" ")[1]
            else:
                self.dir = self.dir + "/" + args.split(" ")[1]
            print self.dir
            return True
        elif (args.split(" ")[0] == "cp"):
            self.CP.command("320 2 " + args.split(" ")[1] + " " + args.split(" ")[2], self)
            return True
        #execution
        elif (args[0] == "/"):
        ...
        #termination
            ...
            self.CP.command("320 4 " + args.split(" ")[1], self)
            return True
        elif (args.split(" ")[0] == "ps"):
            self.CP.command("320 5", self)
            return True
